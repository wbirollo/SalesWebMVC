...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "João", "joao@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(1999, 7, 10), 2500.0, d2);
            Seller s3 = new Seller(3, "Fernanda", "fernanda@gmail.com", new DateTime(2000, 5, 2), 1500.0, d4);
            Seller s4 = new Seller(4, "Davi", "davi@gmail.com", new DateTime(1985, 3, 30), 2300.00, d4);
            Seller s5 = new Seller(5, "José", "jose@gmail.com", new DateTime(1977, 11, 12), 800.0, d3);
            Seller s6 = new Seller(6, "Helena", "helena@gmail.com", new DateTime(1990, 4, 1), 1800.0, d1);
